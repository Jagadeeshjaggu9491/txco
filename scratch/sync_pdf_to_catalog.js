        ...
        sections: [
          {
            ...
            paragraphs: [
              'Kammprofile Gaskets are semi-metallic sealing solutions comprising a grooved (serrated) metallic core with soft facing layers applied to both sides.',
              'The concentric serrated profile concentrates the bolt load onto narrow contact bands, creating high seating stress at relatively low bolt loads. The soft facing layers conform to flange surface imperfections, providing effective sealing and protecting the flange faces from damage.',
              'At TXCO Sealing Products Private Limited, Kammprofile Gaskets are designed for demanding applications involving high pressure, elevated temperature and severe operating conditions. Core materials and soft facings are selected according to process media, operating parameters and flange design, supporting compliance with applicable ASME and EN standards.',
            ],
            showAssemblyDiagram: true,
            diagramType: 'weld-lip',
          },
          {
            ...
            bullets: [
              ...
              'Soft facings conform to surface imperfections, supporting effective sealing and protecting flange seating faces.',
          ...
          },
          {
            ...
            bullets: [
              ...
              'Recommended for high-pressure, elevated-temperature and severe process conditions.',
              'Suitable for critical process piping and equipment flange connections.',
            ],
          },
        ],
      },
        ...
        sections: [
          {
            ...
            paragraphs: [
              'Metal Jacketed Gaskets consist of a soft, compressible filler material enclosed within a metallic outer shell or jacket. The metallic jacket provides mechanical strength, chemical compatibility and blowout resistance, while the compressible filler allows the gasket to conform to flange surface irregularities under bolt load.',
              'At TXCO Sealing Products Private Limited, Metal Jacketed Gaskets are manufactured for demanding static sealing applications, particularly in heat exchangers, pressure vessels, reactors and process piping. Gaskets are available in various jacket styles, materials and filler configurations, manufactured to standard dimensions or custom drawings.',
            ],
            showAssemblyDiagram: true,
            diagramType: 'weld-lip',
          },
          {
            ...
            bullets: [
              'Feature a corrugated metallic jacket that encloses the compressible filler material.',
              'The corrugated profile creates multiple contact lines across the sealing face, improving seating capability under lower bolt loads.',
              'Provides good recovery and resilience under pressure and temperature cycling.',
              'Commonly used in circular and non-circular flange configurations, heat exchangers and low-to-medium pressure vessels.',
            ],
          },
          {
            heading: '2. FLAT METAL JACKETED GASKETS',
            bullets: [
              'Consist of a flat metallic jacket enclosing a soft filler core, typically in single-jacketed or double-jacketed construction.',
              'The flat profile provides a smooth contact surface suitable for narrow flange widths.',
              'Requires sufficient bolt load to achieve effective compression of the filler and sealing of the metallic jacket.',
              'Suitable for smooth, flat-face and raised-face flanges where space and gasket width are limited.',
            ],
          },
          {
            heading: '3. DOUBLE JACKETED GASKETS',
            bullets: [
              'Incorporate a metallic jacket that completely encloses the soft filler material on both faces and edges.',
              'Provides high mechanical strength, blowout resistance and protection of the filler from process media.',
              'Widely used in high-pressure and high-temperature process applications.',
              'Standard sealing solution for heat exchanger flanges, pressure vessel covers and boiler equipment.',
            ],
          },
          {
            heading: '4. HEAT EXCHANGER GASKETS',
            bullets: [
              'Engineered specifically for shell-and-tube heat exchanger applications.',
              'Available with custom partition bar (pass bar) configurations to suit single-pass and multi-pass exchanger channels.',
              'Partition bars are welded or integrally formed to maintain sealing between pass compartments.',
              'Manufactured to exact equipment drawings, ensuring dimensional fit with exchanger channels, floating heads and shell flanges.',
              'Available in various metallurgy and filler combinations to suit operating temperature, pressure and process fluid conditions.',
            ],
          },
        ],
      },
        ...
        sections: [
          {
            ...
            paragraphs: [
              'Flange Isolation Kits are engineered sealing and electrical-isolation assemblies installed in flanged pipe connections to prevent galvanic corrosion and support cathodic protection systems. By electrically isolating adjacent flanges, these kits eliminate metal-to-metal contact between dissimilar metals and control the flow of stray electrical currents in piping networks.',
              'At TXCO Sealing Products Private Limited, Flange Isolation Kits are designed for critical pipeline and process applications in oil & gas, petrochemical, chemical, refining, water transmission and offshore industries. Kits are configured according to flange standard, pressure class, temperature, process media and cathodic protection requirements.',
            ],
            showAssemblyDiagram: true,
            diagramType: 'weld-lip',
          },
          {
            heading: 'TX-ISOPRO™',
            bullets: [
              'G-10 / G-11 Glass-Reinforced Epoxy (GRE) Retainer with dual elastomeric (FKM / NBR) or PTFE spring-energized seals.',
              'Engineered for critical high-pressure hydrocarbon transmission, offshore pipelines, and electrical CP isolation up to ASME Class 2500.',
            ],
          },
          {
            heading: 'TX-CERAMPRO™',
            bullets: [
              'High-Temperature Ceramic-Coated Sealing core for extreme thermal duties exceeding 400°C.',
              'Provides simultaneous fire-safe fluid containment and dielectric insulation.',
              'Eliminates thermal degradation risks common in conventional phenolic or epoxy retainers.',
              'Compatible with aggressive chemical lines, refinery hydrogen loops, and hot thermal fluids.',
              'Manufactured to standard ASME B16.5, ASME B16.47, and API 6A dimensions.',
            ],
          },
          {
            heading: 'TX TYPE D – RTJ ISOLATION GASKET',
            bullets: [
              'Designed specifically for Ring Type Joint (RTJ) flange grooves.',
              'Features a precision-machined oval or octagonal insulating core manufactured from G-10 / G-11 GRE or high-strength phenolic material.',
              'Fits accurately within the standard RTJ groove, maintaining electrical isolation between mating RTJ flanges.',
              'Suitable for high-pressure systems where RTJ flange designs are specified.',
              'Commonly used in oil & gas production, wellheads and high-pressure transmission lines.',
            ],
          },
          {
            heading: 'TX TYPE -N : FLANGE ISOLATION GASKET',
            bullets: [
              'Designed for Raised Face (RF) and Flat Face (FF) flange connections.',
              'Available in Type E (full-face) and Type F (inside bolt circle) configurations.',
              'Manufactured with an insulating retainer material such as G-10, G-11, phenolic or reinforced composite.',
              'Sealing is achieved through elastomeric O-rings (such as NBR, FKM or EPDM) or PTFE sealing elements located on both sides of the retainer.',
              'Provides effective sealing while maintaining electrical isolation across the joint.',
              'Suitable for moderate-to-high pressure applications in water, wastewater, chemical, oil and gas services.',
              'Supplied complete with insulating sleeves (Mylar, Nomex, G-10) and insulating washers (G-10, Phenolic) with steel backup washers.',
              'Available across standard ASME, EN and international flange dimensions.',
            ],
          },
        ],
      },
        ...
        sections: [
          {
            ...
            paragraphs: [
              'Non-metallic gaskets are compressible sealing components manufactured from elastomeric, fluoropolymer and fibrous materials. They are designed to conform easily to flange surface irregularities under relatively low bolt loads, making them suitable for low-to-medium pressure and temperature applications.',
              'TXCO Sealing Products Private Limited offers a comprehensive range of non-metallic gaskets, including Rubber Gaskets, PTFE and ePTFE Gaskets, and Compressed Non-Asbestos Fiber (CNAF) sheets. Materials are selected based on chemical compatibility, operating temperature, pressure, flange type and service media.',
              'Our non-metallic sealing solutions support reliable performance across chemical processing, water and wastewater, pharmaceutical, food and beverage, power generation and general industrial piping applications.',
            ],
            showAssemblyDiagram: true,
            diagramType: 'weld-lip',
          },
        ...
        sections: [
          {
            ...
            paragraphs: [
              'Rubber Gaskets are elastomeric sealing elements that provide effective sealing under low bolt loading due to their high compressibility and elastic recovery.',
              'They conform readily to minor flange face irregularities, making them suitable for flat face (FF) and raised face (RF) flanges in utility and process applications.',
            ],
            showAssemblyDiagram: true,
            diagramType: 'weld-lip',
          },
        ...
        sections: [
          {
            ...
            paragraphs: [
              'Expanded PTFE (ePTFE) is manufactured by expanding 100% virgin PTFE into a multidirectional fibrous network. This structure significantly reduces cold flow and creep relaxation while maintaining complete chemical inertness.',
              'ePTFE conforms easily to rough, damaged, or glass-lined flange surfaces under low bolt torque, providing a highly reliable and durable seal across pH 0–14 environments.',
            ],
            showAssemblyDiagram: true,
            diagramType: 'weld-lip',
          },
          {
            heading: 'KEY FEATURES & FORMS',
            bullets: [
              'ePTFE Sheet Gaskets: Multidirectionally expanded sheets for universal chemical resistance and high torque retention.',
              'ePTFE Joint Sealant Tape: Self-adhesive continuous cord/tape that installs quickly on large, complex or irregular flange faces.',
              'Low Bolt-Load Sealability: Highly conformable to delicate or non-parallel flanges such as glass-lined steel, plastic, and FRP.',
              'Zero Creep & Cold Flow Resistance: Multidirectional expansion locks the microstructure against relaxation under thermal cycling.',
            ],
          },
        ],
      },
        ...
        sections: [
          {
            ...
            paragraphs: [
              'Steel Insert Rubber Gaskets feature a vulcanized elastomeric body with an embedded steel core that maintains joint geometry under high compressive loads.',
              'The elastomer provides flexibility and surface conformity, helping accommodate minor flange irregularities.',
              'The composite construction is suitable for applications requiring reliable sealing, mechanical strength and resistance to blowout.',
        ...
        sections: [
          {
            ...
            paragraphs: [
              'Steel Insert Graphite Gaskets combine expanded flexible graphite facings mechanically clinched to a 316L tanged steel core (or adhesively laminated to a flat metallic sheet).',
              'The graphite provides exceptional thermal endurance and micro-sealing capability, while the metallic core provides mechanical rigidity and blowout resistance.',
              'Ideal for steam, thermal fluids, hydrocarbons, and severe chemical services up to 650°C in non-oxidizing atmospheres.',
            ],
          },
        ],
      },
        ...
        sections: [
          {
            ...
            paragraphs: [
              'Plug Gaskets are specialized metallic and non-metallic sealing elements engineered to seal industrial equipment and piping plugs.',
              'Designed to ensure pressure containment, leak prevention and chemical resistance in threaded, blind and access-port connections.',
              'Manufactured to exact dimensional specifications and standard industrial tolerances, matching the mating plug and port geometry.',
            ],
          },
        ],
      },
        ...
        sections: [
          {
            ...
            paragraphs: [
              'TXCO Sealing Products Private Limited manufactures and supplies industrial flanges in stainless steel, duplex, super duplex, nickel-based and special alloys, in accordance with applicable international standards, approved drawings and customer or project specifications.',
      ...
      'weld-neck-flanges': {
        ...
        sections: [
          ...
          },
          {
            ...
            bullets: [
              'Oil & Gas: High-pressure production manifolds, wellheads, and transmission piping.',
              'Refineries and Petrochemical Plants: Cat crackers, hydrocrackers, and high-temp distillate lines.',
              'Chemical Processing: Corrosive acid loops and hazardous fluid containment.',
              'Power Generation: Main steam lines, boiler feed manifolds, and high-pressure steam circuits.',
              'Pressure Vessels and Heat Exchangers: Channel heads, shell nozzles, and vessel connections.',
              'High-Pressure & High-Temperature Piping: Severe-duty systems subject to thermal cycling and line stresses.',
            ],
          },
        ],
      },
      ...
      'slip-on-flanges': {
        ...
        sections: [
          ...
          },
          {
            heading: 'TYPICAL APPLICATIONS',
            bullets: [
              'Process Piping: Moderate-pressure process lines and fluid distribution loops.',
              'Utility Systems: Cooling water, compressed air, and steam condensate lines.',
              'General Industrial Piping: Manufacturing facilities and plant utilities.',
              'Equipment Connections: Low-to-moderate pressure pump and tank nozzles.',
              'Water and Utility Services: Municipal and industrial water transmission lines.',
            ],
          },
        ],
      },
      ...
      'blind-flanges': {
        ...
        sections: [
          ...
          },
          {
            heading: 'TYPICAL APPLICATIONS',
            bullets: [
              'Pipeline Isolation: Positive mechanical isolation of line sections during maintenance.',
              'Pressure Vessel Nozzles: Temporary or permanent blanking of vessel manways and inspection ports.',
              'Equipment Connections: Blanking pump suction/discharge ports and manifold headers.',
              'Hydrostatic Testing: Temporary end closures for pressure testing pipeline sections.',
              'Maintenance and Shutdowns: Positive shut-off during turnaround and overhaul cycles.',
              'Pipeline Termination: Dead-end termination of future expansion lines.',
            ],
          },
        ],
      },
      ...
      'socket-weld-flanges': {
        ...
        sections: [
          ...
          },
          {
            heading: 'TYPICAL APPLICATIONS',
            bullets: [
              'Small-Bore Piping: High-pressure piping systems from NPS 1/2" to NPS 2".',
              'High-Pressure Piping: High-integrity compact lines in chemical and refinery units.',
              'Instrumentation Systems: Impulse lines, pressure transmitters, and sampling manifolds.',
              'Chemical Processing: Corrosive small-diameter fluid and gas circuits.',
              'Hydraulic Systems: High-pressure fluid power lines and control manifolds.',
              'Process Piping: Auxiliary piping loops in power generation and petrochemical plants.',
            ],
          },
        ],
      },
      ...
      'lap-joint-flanges': {
        ...
        sections: [
          ...
          },
          {
            heading: 'TYPICAL APPLICATIONS',
            bullets: [
              'Chemical Processing: Cost-effective systems using high-alloy stub ends with backing flanges.',
              'Corrosive Services: Highly aggressive fluid lines requiring exotic metallurgy at the wetted face.',
              'Stainless-Steel Piping: Simplifies alignment on rigid stainless process manifolds.',
              'Duplex and Special-Alloy Piping: Reduces material costs by utilizing carbon backing rings with alloy stub ends.',
              'Process Plants: Systems requiring frequent cleaning, inspection, or disassembly.',
              'Maintenance-Intensive Systems: Speeds up bolt hole alignment during plant turnaround.',
            ],
          },
        ],
      },
      ...
      'threaded-screwed-flanges': {
        ...
        sections: [
          ...
          },
          {
            heading: 'TYPICAL APPLICATIONS',
            bullets: [
              'Utility Systems: Water, compressed air, and general plant utilities.',
              'Instrumentation: Instrument take-off points and sampling systems.',
              'Small-Diameter Piping: Low-pressure small-bore utility networks.',
              'Selected Process Applications: Non-critical services with threaded pipe.',
              'Applications where Welding is Restricted: Hazardous or explosive areas where hot work is prohibited.',
            ],
          },
        ],
      },
      ...
      'orifice-flanges': {
        ...
        sections: [
          ...
          },
          {
            heading: 'TYPICAL APPLICATIONS',
            bullets: [
              'Oil & Gas: Custody transfer metering, gas flow measurement, and separator outlet monitoring.',
              'Refineries: Feedstock flow monitoring, fuel gas measurement, and product blending.',
              'Petrochemical Plants: Precise reactant and catalyst flow rate monitoring.',
              'Chemical Processing: In-line chemical metering and volumetric flow calculation.',
              'Process Plants: Continuous stream monitoring across main process headers.',
              'Flow Measurement Systems: Standard differential pressure metering stations (ASME B16.36).',
            ],
          },
        ],
      },
        ...
        sections: [
          {
            ...
            paragraphs: [
              'TXCO Monolithic Insulation Joints (MIJs) are factory-assembled, solid-state, fully welded fittings engineered to provide permanent electrical isolation and cathodic protection (CP) in gas, oil, water, and petrochemical pipelines.',
              'Unlike traditional flanged isolation kits that rely on external sleeves and washers susceptible to environmental degradation, TXCO MIJs feature an integrated, boltless design that eliminates maintenance requirements, prevents galvanic corrosion, and ensures 100% leak-proof pipeline integrity over extended operating lifespans.',
            ],
            showAssemblyDiagram: true,
            diagramType: 'weld-lip',
          },
          {
            ...
            bullets: [
              'Boltless Monolithic Architecture: Factory-welded, pre-assembled structural forged steel components eliminate bolted connections, external gaskets, and loose insulating washers.',
              'Permanent Electrical Isolation: High-dielectric thermosetting epoxy resin filling provides dielectric resistance exceeding 50 Megaohms at 1,000V DC and withstands AC electrical surges up to 5,000V.',
              'Dual-Barrier Elastomeric Sealing: Incorporates primary and secondary high-grade elastomer seals (FKM / HNBR / EPDM) to ensure zero fluid bypass and gas-tight containment.',
              'Full-Bore Hydrodynamic Design: Precision-machined bore matches pipe internal diameter, allowing unrestricted pigging operations and minimizing flow turbulence and pressure drop.',
              '100% Factory Tested & Certified: Undergoes rigorous hydrostatic pressure testing (1.5x design pressure), electrical resistance testing, and dielectric breakdown testing.',
              'Maintenance-Free Underground Service: Completely sealed against water ingress, soil stress, and stray currents, making it ideal for direct burial without protective vaults.',
            ],
          },
          {
            heading: 'COMPONENT & MATERIAL MATRIX',
            table: {
              headers: ['Component', 'Primary Materials', 'Temperature Range'],
              rows: [
                { code: 'Forged Body / Hubs', description: 'ASTM A105, A694 (F52–F70), A350 LF2, Stainless 316L, Duplex', thickness: '-50°C to +150°C' },
                { code: 'Insulating Ring', description: 'High-Strength Glass Epoxy Laminate (G-10 / G-11 / FR4)', thickness: 'Dielectric > 20 kV/mm' },
                { code: 'Elastomeric Seals', description: 'Viton® (FKM), HNBR (Sour Gas), EPDM (Water)', thickness: 'Zero Extrusion / RGD Certified' },
                { code: 'Dielectric Filler', description: 'High-Purity Hydrophobic Thermoset Epoxy Resin', thickness: '100% Cavity Encapsulation' },
                { code: 'External Coating', description: 'Solvent-Free Liquid Epoxy / 3LPE / FBE Pipeline Coating', thickness: 'Min. 500 μm Thickness' },
              ],
            },
          },
          {
            heading: 'PERFORMANCE PARAMETERS & TECHNICAL SPECIFICATIONS',
            table: {
              headers: ['Performance Parameter', 'Technical Specification', 'Applicable Design Standard'],
              rows: [
                { code: 'Pipeline Diameter Range', description: 'NPS 1/2" through NPS 60" (DN15 – DN1500)', thickness: 'ASME B31.3, B31.4, B31.8' },
                { code: 'Pressure Class Rating', description: 'ASME Class 150 to Class 2500 / API 10,000 PSI', thickness: 'ASME B16.5 / ASME B16.47' },
                { code: 'Hydrostatic Test Pressure', description: '1.5 times the Design Working Pressure', thickness: 'Factory Test per API Spec 6D' },
                { code: 'Hydrostatic Electrical Resistance', description: '≥ 50 Megaohms @ 1,000 V DC (Dry Test)', thickness: 'NACE SP0286 / ISO 15590-2' },
                { code: 'Dielectric High-Voltage Breakdown', description: '≥ 5.0 kV @ 50 Hz AC for 1 Minute', thickness: 'Surge Immunity Standard' },
              ],
            },
          },
        ],
      ...
      'about-valve-components': {
        ...
        sections: [
          ...
          },
          {
            ...
            bullets: [
              'Precision O-Rings & Backup Rings: Molded from FKM, HNBR, and FFKM with NORSOK M-710 RGD certification for pressures up to 10,000 PSI.',
              'API 622 / ISO 15848-1 Low-Emission Gland Packing: Precision-braided expanded graphite and Inconel-reinforced yarn for zero-leakage stem sealing.',
              'Valve Seats & Inserts: CNC-machined PTFE, PEEK, Devlon V, PCTFE, and metallic seat rings for bubble-tight shut-off in ball, gate, and globe valves.',
            ],
          },
          {
            ...
            table: {
              ...
              rows: [
                { code: 'Precision O-Rings', description: 'FFKM, FKM (Viton), HNBR, EPDM, Silicone', thickness: '-50°C to +315°C', reweld: 'Up to 10,000 PSI', radial: 'NORSOK M-710, NACE MR0175' },
                { code: 'Backup Rings', description: 'Virgin PTFE, PEEK, Devlon, Carbon-Filled PTFE', thickness: '-196°C to +260°C', reweld: 'Up to 15,000 PSI', radial: 'ASME B16.34, API 6D' },
                { code: 'Stem Packing Sets', description: 'Expanded Graphite, Inconel Wire, Carbon Yarn', thickness: '-200°C to +650°C', reweld: 'Up to 4,500 PSI', radial: 'API 622, ISO 15848-1 Class A' },
                { code: 'Soft Valve Seats', description: 'Virgin/Filled PTFE, PEEK, PCTFE, Devlon V', thickness: '-196°C to +260°C', reweld: 'Class 150 to 2500', radial: 'API 6D, API 607, API 598' },
                { code: 'Metallic Seat Rings', description: 'Stainless 316/316L, Inconel 625/718, Stellite', thickness: '-196°C to +800°C', reweld: 'Class 150 to 4500', radial: 'API 6A, API 6D, ASME B16.34' },
              ],
            },
          },
        ],
        ...
        sections: [
          {
            ...
            paragraphs: [
              'Molded from high-performance elastomers (FKM, HNBR, EPDM) and chemically inert Perfluoroelastomers (FFKM), TXCO O-rings provide primary static and dynamic sealing for valve stems, body joints, and internal cartridges.',
              'Certified for Rapid Gas Decompression (RGD / AED) under NORSOK M-710, they resist micro-blistering during rapid depressurization up to 10,000 PSI. Paired with PEEK or PTFE backup rings, they eliminate seal extrusion under severe differential pressures.',
            ],
          },
        ],
      },
        ...
        sections: [
          {
            ...
            paragraphs: [
              'Functioning as the dynamic stem seal for rotating and reciprocating valves, TXCO gland packings are precision-braided from expanded flexible graphite, Inconel-wire reinforcement, carbon yarn, and modified ePTFE.',
              'Their self-lubricating, high-density construction maintains continuous radial contact against stuffing box walls, minimizing actuator breakout torque while exceeding strict fugitive emissions standards (API 622, TA-Luft, ISO 15848-1 Class A).',
            ],
          },
        ],
      },
        ...
        sections: [
          {
            ...
            paragraphs: [
              'CNC-machined for bubble-tight shut-off in ball, butterfly, gate, and globe valves, TXCO seat rings deliver mechanical strength and thermal memory.',
              'Manufactured from engineering thermoplastics—including Virgin/Filled PTFE, PEEK, PCTFE, Devlon V, and Nylon—or solid metallic base rings, these seats resist creep deformation under heavy line loads, maintaining sealing integrity from cryogenic LNG conditions (-196°C) to elevated process temperatures (+260°C).',
            ],
          },
        ],
      },
